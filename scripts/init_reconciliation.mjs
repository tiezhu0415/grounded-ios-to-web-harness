...
coverage.reconciliation_policy = 'Source declarations, codebase-memory navigation targets, source UI-state branches, and Maestro runtime visits must agree before APP_COMPLETE.';
